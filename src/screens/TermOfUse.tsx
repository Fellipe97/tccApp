                ...
                <VStack mt={10} pb={8} >
                    <ScrollView px={5}>
                        ...
                        >
                            ...
                            A plataforma realiza a venda à distância por meio eletrônico dos seguintes produtos ou serviços: funcionalidades de alertas sobre substâncias que o usuário deseja evitar que estão presentes em alguns produtos.{'\n'}{'\n'}
                            2. Da aceitação{'\n'}
