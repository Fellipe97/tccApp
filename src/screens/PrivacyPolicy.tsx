                ...
                <VStack mt={7}  pb={8} >
                    <ScrollView px={5}>
                        ...
                        >
                            ...
                            A presente Política de Privacidade contém informações sobre coleta, uso, armazenamento, tratamento e proteção dos dados pessoais dos usuários e visitantes do aplicativo SmartCurly, com a finalidade de demonstrar absoluta transparência quanto ao assunto e esclarecer a todos interessados sobre os tipos de dados que são coletados, os motivos da coleta e a forma como os usuários podem gerenciar ou excluir as suas informações pessoais.{'\n'}
                            Esta Política de Privacidade aplica-se a todos os usuários e visitantes do aplicativo SmartCurly e integra os Termos e Condições Gerais de Uso do aplicativo SmartCurly, devidamente inscrita no CPF sob o nº 15056857700, doravante nominada SmartCurly.{'\n'}
                            ...
                            ●	Quando o usuário cria uma conta/perfil na plataforma SmartCurly: esses dados são os dados de identificação básicos, como: e-mail, nome completo, telefone e data de nascimento). A partir deles, podemos identificar o usuário e o visitante, além de garantir uma maior segurança e bem-estar às suas necessidade. Ficam cientes os usuários e visitantes de que seu perfil na plataforma estará acessível a todos demais usuários e visitantes da plataforma SmartCurly.{'\n'}
                            ●	Quando um usuário e visitante acessa o aplicativo SmartCurly: as informações sobre interação e acesso são coletadas pela empresa para garantir uma melhor experiência ao usuário e visitante. Estes dados podem tratar sobre as palavras-chaves utilizadas em uma busca, o compartilhamento de um documento específico, comentários, visualizações de páginas, perfis, a URL de onde o usuário e visitante provêm, o navegador que utilizam e seus IPs de acesso, dentre outras que poderão ser armazenadas e retidas.{'\n'}
                            ●	Por intermédio de terceiro: a plataforma SmartCurly recebe dados de terceiros, como Facebook e Google, quando um usuário faz login com o seu perfil de um desses sites. A utilização desses dados é autorizada previamente pelos usuários junto ao terceiro em questão.{'\n'}
                            ●	outras{'\n'}
                            ...
                            ●	Dados para a criação da conta/perfil na plataforma SmartCurly: e-mail, nome completo, telefone e data de nascimento.{'\n'}
                            ...
                            ●	Dados sensíveis: a plataforma poderá coletar os seguintes dados sensíveis do usuário - orientação de gênero e características capilar.{'\n'}
                            ...
                            Os dados pessoais do usuário e do visitante coletados e armazenados pela plataforma SmartCurly tem por finalidade:{'\n'}
                            ...
                            O usuário e o visitante da plataforma SmartCurly manifesta conhecer e aceitar que pode ser utilizado um sistema de coleta de dados de navegação mediante à utilização de cookies.{'\n'}
                            ...
                            O usuário tem direito de retirar o seu consentimento a qualquer tempo, para tanto deve entrar em contato através do e-mail equipesmartcurly@gmail.com{'\n'}
